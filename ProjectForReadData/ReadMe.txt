...
Это приложение ProjectForReadData создано автоматически с помощью мастера 
приложений.  

Здесь приведены краткие сведения о содержимом каждого из файлов, использованных 
при создании приложения ProjectForReadData.

ProjectForReadData.vcxproj
...
ProjectForReadData.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) с именем ProjectForReadData.pch и файла предкомпилированных типов 
    с именем StdAfx.obj.
